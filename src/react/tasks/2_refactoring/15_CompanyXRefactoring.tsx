/** 
 * Проведите код-ревью и рефакторинг компонента UserPostsList.
 * Компонент загружает список постов пользователя, позволяет фильтровать их по названию и выбирать конкретный пост.
 * 
 * Найдите и исправьте допущенные в коде ошибки, антипаттерны и утечки ресурсов.
 */
