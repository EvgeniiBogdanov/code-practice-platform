...
/**
 * Задача: Кэширование сетевых запросов
 *
 * Требования:
 * - Реализуйте кэширование результатов запросов с помощью структуры данных Map.
 * - При повторном поиске с теми же параметрами (имя и статус) данные должны браться из кэша без выполнения повторного сетевого вызова.
 */
