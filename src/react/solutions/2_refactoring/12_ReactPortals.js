...
/*
=== Разбор решения ===
В React модальное окно логически принадлежит компоненту FeedPost (оно использует его стейт), но физически в DOM оно должно находиться на самом верхнем уровне (например, прямо перед </body>), чтобы никакие родительские стили на него не влияли. Для этого используется ReactDOM.createPortal.
*/
