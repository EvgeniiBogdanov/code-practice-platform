...
import WarmupCandidate19 from "../tasks/1_warmup/19_UseMemoPractice.jsx?raw";
import WarmupSolution19 from "../solutions/1_warmup/19_UseMemoPractice.jsx?raw";
...
import WarmupCandidate21 from "../tasks/1_warmup/21_UseCallbackPractice.jsx?raw";
import WarmupSolution21 from "../solutions/1_warmup/21_UseCallbackPractice.jsx?raw";
...
import Candidate2 from "../tasks/3_middle/2_FetchPersonsDebounce.jsx";
import Candidate3 from "../tasks/3_middle/3_FetchPersonsCache.jsx";
import Candidate4 from "../tasks/3_middle/4_ArrayNoMutation.jsx";
import Candidate5 from "../tasks/3_middle/5_TodoList.jsx";
import Candidate6 from "../tasks/3_middle/6_TodoListCompanyX.jsx";
import Candidate7 from "../tasks/3_middle/7_RefetchImage.jsx";
import Candidate8 from "../tasks/3_middle/8_PostsManager.jsx";
import Candidate9 from "../tasks/3_middle/9_PasswordCompanyX.jsx";
import CandidateAdvanced1 from "../tasks/4_strong/1_FetchUsersReducer/index.jsx";
import CandidateAdvanced2 from "../tasks/4_strong/2_FetchUsersRTK/index.jsx";
import CandidateAdvanced3 from "../tasks/4_strong/3_FetchUsersRTKSelectors/index.jsx";
import Candidate1Raw from "../tasks/3_middle/1_FetchPersons.jsx?raw";
import Candidate2Raw from "../tasks/3_middle/2_FetchPersonsDebounce.jsx?raw";
import Candidate3Raw from "../tasks/3_middle/3_FetchPersonsCache.jsx?raw";
import Candidate4Raw from "../tasks/3_middle/4_ArrayNoMutation.jsx?raw";
import Candidate5Raw from "../tasks/3_middle/5_TodoList.jsx?raw";
import Candidate6Raw from "../tasks/3_middle/6_TodoListCompanyX.jsx?raw";
import Candidate7Raw from "../tasks/3_middle/7_RefetchImage.jsx?raw";
import Candidate8Raw from "../tasks/3_middle/8_PostsManager.jsx?raw";
import Candidate9Raw from "../tasks/3_middle/9_PasswordCompanyX.jsx?raw";
import CandidateAdvanced1Raw from "../tasks/4_strong/1_FetchUsersReducer/index.jsx?raw";
...
import Solution2 from "../solutions/3_middle/2_FetchPersonsDebounce.jsx";
import Solution2Raw from "../solutions/3_middle/2_FetchPersonsDebounce.jsx?raw";
import Solution3 from "../solutions/3_middle/3_FetchPersonsCache.jsx";
import Solution3Raw from "../solutions/3_middle/3_FetchPersonsCache.jsx?raw";
import Solution4 from "../solutions/3_middle/4_ArrayNoMutation.jsx";
import Solution4Raw from "../solutions/3_middle/4_ArrayNoMutation.jsx?raw";
import Solution5 from "../solutions/3_middle/5_TodoList.jsx";
import Solution5Raw from "../solutions/3_middle/5_TodoList.jsx?raw";
import Solution6 from "../solutions/3_middle/6_TodoListCompanyX.jsx";
import Solution6Raw from "../solutions/3_middle/6_TodoListCompanyX.jsx?raw";
import Solution7 from "../solutions/3_middle/7_RefetchImage.jsx";
import Solution7Raw from "../solutions/3_middle/7_RefetchImage.jsx?raw";
import Solution8 from "../solutions/3_middle/8_PostsManager.jsx";
import Solution8Raw from "../solutions/3_middle/8_PostsManager.jsx?raw";
import Solution9 from "../solutions/3_middle/9_PasswordCompanyX.jsx";
import Solution9Raw from "../solutions/3_middle/9_PasswordCompanyX.jsx?raw";
import SolutionAdvanced1 from "../solutions/4_strong/1_FetchUsersReducer/index.jsx";
import SolutionAdvanced2 from "../solutions/4_strong/2_FetchUsersRTK/index.jsx";
import SolutionAdvanced3 from "../solutions/4_strong/3_FetchUsersRTKSelectors/index.jsx";

import SolutionAdvanced1_Index from "../solutions/4_strong/1_FetchUsersReducer/index.jsx?raw";
import SolutionAdvanced1_Hook from "../solutions/4_strong/1_FetchUsersReducer/useFetchUsers.js?raw";
import SolutionAdvanced1_Reducer from "../solutions/4_strong/1_FetchUsersReducer/reducer.js?raw";
...
import ReactTsSolution1 from "../solutions/5_react_ts/1_GenericList.tsx?raw";
import ReactTsCandidate2 from "../tasks/5_react_ts/2_PolymorphicButton.tsx?raw";
import ReactTsSolution2 from "../solutions/5_react_ts/2_PolymorphicButton.tsx?raw";
import ReactTsCandidate3 from "../tasks/5_react_ts/3_TypedEvents.tsx?raw";
import ReactTsSolution3 from "../solutions/5_react_ts/3_TypedEvents.tsx?raw";
import ReactTsCandidate4 from "../tasks/5_react_ts/4_DiscriminatedUnions.tsx?raw";
import ReactTsSolution4 from "../solutions/5_react_ts/4_DiscriminatedUnions.tsx?raw";
import ReactTsCandidate5 from "../tasks/5_react_ts/5_UtilityTypesReact.tsx?raw";
import ReactTsSolution5 from "../solutions/5_react_ts/5_UtilityTypesReact.tsx?raw";
import ReactTsCandidate6 from "../tasks/5_react_ts/6_TypedCustomHook.tsx?raw";
import ReactTsSolution6 from "../solutions/5_react_ts/6_TypedCustomHook.tsx?raw";
import ReactTsCandidate7 from "../tasks/5_react_ts/7_TypedContext.tsx?raw";
import ReactTsSolution7 from "../solutions/5_react_ts/7_TypedContext.tsx?raw";
import ReactTsCandidate8 from "../tasks/5_react_ts/8_TypedChildrenProps.tsx?raw";
import ReactTsSolution8 from "../solutions/5_react_ts/8_TypedChildrenProps.tsx?raw";
import ReactTsCandidate9 from "../tasks/5_react_ts/9_TypedUseReducer.tsx?raw";
import ReactTsSolution9 from "../solutions/5_react_ts/9_TypedUseReducer.tsx?raw";
import ReactTsCandidate10 from "../tasks/5_react_ts/10_MutuallyExclusiveProps.tsx?raw";
import ReactTsSolution10 from "../solutions/5_react_ts/10_MutuallyExclusiveProps.tsx?raw";
import ReactTsCandidate11 from "../tasks/5_react_ts/11_TypedForwardRef.tsx?raw";
import ReactTsSolution11 from "../solutions/5_react_ts/11_TypedForwardRef.tsx?raw";
import ReactTsCandidate12 from "../tasks/5_react_ts/12_MutableVsImmutableRef.tsx?raw";
import ReactTsSolution12 from "../solutions/5_react_ts/12_MutableVsImmutableRef.tsx?raw";

// Импорт компонентов React + TS (Практика)
import ReactTsPracticeCandidate1 from "../tasks/6_react_ts_practice/1_UseEffectFetch.tsx";
import ReactTsPracticeSolution1 from "../solutions/6_react_ts_practice/1_UseEffectFetch.tsx";
import ReactTsPracticeCandidate1Raw from "../tasks/6_react_ts_practice/1_UseEffectFetch.tsx?raw";
import ReactTsPracticeSolution1Raw from "../solutions/6_react_ts_practice/1_UseEffectFetch.tsx?raw";
import ReactTsPracticeCandidate2 from "../tasks/6_react_ts_practice/2_RefetchImage.tsx";
import ReactTsPracticeSolution2 from "../solutions/6_react_ts_practice/2_RefetchImage.tsx";
import ReactTsPracticeCandidate2Raw from "../tasks/6_react_ts_practice/2_RefetchImage.tsx?raw";
import ReactTsPracticeSolution2Raw from "../solutions/6_react_ts_practice/2_RefetchImage.tsx?raw";
import ReactTsPracticeCandidate3 from "../tasks/6_react_ts_practice/3_PostsManager.tsx";
import ReactTsPracticeSolution3 from "../solutions/6_react_ts_practice/3_PostsManager.tsx";
import ReactTsPracticeCandidate3Raw from "../tasks/6_react_ts_practice/3_PostsManager.tsx?raw";
import ReactTsPracticeSolution3Raw from "../solutions/6_react_ts_practice/3_PostsManager.tsx?raw";
...
export const WARMUP_TASKS = [
  ...
  },
  {
    ...
    articles: [
      ...
      {
        title: "Эффекты в React",
        urlTitle: "Хук useEffect (Doka.guide)",
    ...
    interviewerQuestions: [
      {
        question:
          "Что произойдет, если вызывать setState внутри useEffect без массива зависимостей?",
        answer:
          "Возникнет бесконечный цикл рендеринга! setState вызывает перерисовку компонента, а отсутствие массива зависимостей запускает useEffect заново после каждого рендера.",
      },
    ],
    checklist: [
  ...
  {
    id: "w6",
    title: "6. Исправление асинхронных обновлений",
  ...
  {
    id: "w7",
    title: "7. Безопасное обновление объекта",
  ...
  {
    id: "w8",
    title: "8. Единый обработчик нескольких полей формы",
  ...
  {
    id: "w11",
    title: "11. Фильтрация выпадающим списком (Select)",
  ...
  {
    id: "w12",
    title: "12. Генерация стабильных ключей для данных без ID",
  ...
  {
    id: "w13",
    title: "13. async/await (Синтаксис)",
  ...
  },
  {
    ...
    isRaw: true,
    rawCandidate: WarmupCandidate19,
    rawSolution: WarmupSolution19,
  ...
  {
    id: "w20",
    title: "20. useCallback (Синтаксис)",
  ...
  {
    id: "w21",
    title: "21. useCallback (Практика)",
    desc: "Создайте мемоизированную функцию-обработчик increment с помощью хука useCallback с пустым массивом зависимостей.",
    isRaw: true,
    rawCandidate: WarmupCandidate21,
    rawSolution: WarmupSolution21,
...
export const MAIN_TASKS = [
  {
    ...
    filepath: "src/react/tasks/3_middle/1_FetchPersons.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/2_FetchPersonsDebounce.jsx",
    articles: [
      {
        title: "Оптимизация ввода (Debounce)",
        urlTitle: "Дебаунс функций при поиске (LearnJS)",
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/3_FetchPersonsCache.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/4_ArrayNoMutation.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/5_TodoList.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/6_TodoListCompanyX.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/7_RefetchImage.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/8_PostsManager.jsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/3_middle/9_PasswordCompanyX.jsx",
    articles: [
      {
        title: "Ссылки на значения",
...
export const REACT_TS_TASKS = [
  {
    id: "ts1",
    title: "1. Дженерик компонент списка (Generic List)",
    desc: "Реализуйте универсальный список List с дженерик пропсами и типом getKey.",
    isRaw: true,
    rawCandidate: ReactTsCandidate1,
    rawSolution: ReactTsSolution1,
    filepath: "src/react/tasks/5_react_ts/1_GenericList.tsx",
    articles: [
      {
    ...
    checklist: [
      "Компонент типизирован через дженерик: <T,>(props: ListProps<T>)",
      "getKey принимает T и возвращает string | number для уникального ключа",
      "renderItem типизирован как (item: T) => React.ReactNode",
      "Trailing comma <T,> используется в TSX для отличия от JSX-тега",
    ],
  },
  {
    id: "ts2",
    title: "2. Полиморфный компонент (Polymorphic Button)",
    desc: "Реализуйте компонент Button с поддержкой пропа as и нативных HTML-атрибутов через ComponentPropsWithoutRef.",
    isRaw: true,
    rawCandidate: ReactTsCandidate2,
    rawSolution: ReactTsSolution2,
    filepath: "src/react/tasks/5_react_ts/2_PolymorphicButton.tsx",
    articles: [
      {
    ...
    checklist: [
      "Проп as определяет HTML-элемент: as='a' рендерит <a>, as='button' рендерит <button>",
      "ComponentPropsWithoutRef<E> автоматически подтягивает нативные атрибуты элемента",
      "Omit исключает пересечение кастомных пропсов с нативными",
      "TypeScript подсказывает href только при as='a' и type только при as='button'",
    ],
  },
  {
    id: "ts3",
    title: "3. Типизация событий и форм (SyntheticEvent)",
    desc: "Строго типизируйте обработчики событий ChangeEvent, FormEvent, KeyboardEvent.",
    isRaw: true,
    rawCandidate: ReactTsCandidate3,
    rawSolution: ReactTsSolution3,
    filepath: "src/react/tasks/5_react_ts/3_TypedEvents.tsx",
    articles: [
      {
    ...
    checklist: [
      "React.ChangeEvent<HTMLInputElement> для onChange обработчиков",
      "React.FormEvent<HTMLFormElement> для onSubmit обработчиков",
      "React.KeyboardEvent<HTMLInputElement> для onKeyDown обработчиков",
      "Не используется any для типа объекта события e",
    ],
  },
  {
    id: "ts4",
    title: "4. Discriminated Unions & Type Guards",
    desc: "Перепишите типы пользователей на Discriminated Union и напишите кастомный Type Guard isAdmin.",
    isRaw: true,
    rawCandidate: ReactTsCandidate4,
    rawSolution: ReactTsSolution4,
    filepath: "src/react/tasks/5_react_ts/4_DiscriminatedUnions.tsx",
    articles: [
      {
    ...
    checklist: [
      "Типы объединены через общее поле-дискриминант: role: 'admin' | 'guest'",
      "Type Guard написан как функция-предикат: (user): user is AdminUser",
      "TypeScript автоматически сужает тип после проверки if (isAdmin(user))",
      "Каждый подтип имеет свои уникальные поля (permissions, department)",
    ],
  },
  {
    id: "ts5",
    title: "5. Утилитарные типы (Omit, Record, Pick)",
    desc: "Используйте Omit и Record для создания типов пропсов и словарей из модели данных.",
    isRaw: true,
    rawCandidate: ReactTsCandidate5,
    rawSolution: ReactTsSolution5,
    filepath: "src/react/tasks/5_react_ts/5_UtilityTypesReact.tsx",
    articles: [
      {
    ...
    checklist: [
      "Omit<T, K> используется для исключения полей из типа",
      "Record<K, V> используется для создания словарей с фиксированными ключами",
      "Pick<T, K> используется для выбора подмножества полей из типа",
      "Record гарантирует заполнение значений для ВСЕХ ключей объединения",
    ],
  },
  {
    id: "ts6",
    title: "6. Кастомный хук и кортежи (as const)",
    desc: "Используйте as const для точного вывода типов кортежа [boolean, toggle] в хуке useToggle.",
    isRaw: true,
    rawCandidate: ReactTsCandidate6,
    rawSolution: ReactTsSolution6,
    filepath: "src/react/tasks/5_react_ts/6_TypedCustomHook.tsx",
    articles: [
      {
    ...
    checklist: [
      "return [...] as const превращает массив в readonly кортеж (Tuple)",
      "Без as const TypeScript выводит (boolean | Function)[] вместо [boolean, Function]",
      "Деструктуризация [value, toggle] получает точные типы из кортежа",
      "Хук useToggle типизирован: параметр и возвращаемое значение",
    ],
  },
  {
    id: "ts7",
    title: "7. Типизация Context API (Null Safety)",
    desc: "Создайте типизированный AuthContext со значением null по умолчанию и безопасный хук useAuth.",
    isRaw: true,
    rawCandidate: ReactTsCandidate7,
    rawSolution: ReactTsSolution7,
    filepath: "src/react/tasks/5_react_ts/7_TypedContext.tsx",
    articles: [
      {
    ...
    checklist: [
      "createContext инициализирован с null: createContext<ContextType | null>(null)",
      "Хук useAuth выбрасывает ошибку если context === null (вне Provider)",
      "Не используется as ContextType для обхода типов (антипаттерн)",
      "Provider корректно передаёт value с полной типизацией",
    ],
  },
  {
    id: "ts8",
    title: "8. ReactNode vs ReactElement vs PropsWithChildren",
    desc: "Разграничьте использование типов ReactNode, ReactElement и PropsWithChildren в карточках.",
    isRaw: true,
    rawCandidate: ReactTsCandidate8,
    rawSolution: ReactTsSolution8,
    filepath: "src/react/tasks/5_react_ts/8_TypedChildrenProps.tsx",
    articles: [
      {
    ...
    checklist: [
      "ReactNode используется для children (строки, числа, JSX, null, массивы)",
      "ReactElement используется когда нужен строго один JSX-элемент",
      "PropsWithChildren<P> — утилита для добавления children?: ReactNode к пропсам",
      "Понимание иерархии: ReactElement ⊂ ReactNode",
    ],
  },
  {
    id: "ts9",
    title: "9. Строгая типизация useReducer",
    desc: "Создайте невозможные некорректные состояния редьюсера с помощью Discriminated Union для State и Action.",
    isRaw: true,
    rawCandidate: ReactTsCandidate9,
    rawSolution: ReactTsSolution9,
    filepath: "src/react/tasks/5_react_ts/9_TypedUseReducer.tsx",
    articles: [
      {
    ...
    checklist: [
      "State типизирован как Discriminated Union: { status: 'loading' } | { status: 'success', data: T }",
      "Action типизирован как Discriminated Union с полем type",
      "Невозможно обратиться к data в состоянии loading (TypeScript ошибка)",
      "Switch/case в reducer автоматически сужает тип action по полю type",
    ],
  },
  {
    id: "ts10",
    title: "10. Взаимоисключающие пропсы (never)",
    desc: "Сформируйте тип пропсов с помощью type never, запрещающий передавать count и dot одновременно.",
    isRaw: true,
    rawCandidate: ReactTsCandidate10,
    rawSolution: ReactTsSolution10,
    filepath: "src/react/tasks/5_react_ts/10_MutuallyExclusiveProps.tsx",
    articles: [
      {
  ...
  {
    id: "ts11",
    title: "11. Дженерик forwardRef в компонентах",
    desc: "Сохраните дженерик параметр T в компоненте Select при использовании React.forwardRef.",
    isRaw: true,
    rawCandidate: ReactTsCandidate11,
    rawSolution: ReactTsSolution11,
    filepath: "src/react/tasks/5_react_ts/11_TypedForwardRef.tsx",
    articles: [
      {
  ...
  {
    id: "ts12",
    title: "12. RefObject vs MutableRefObject (useRef)",
    desc: "Исправьте перегрузку useRef, сделав таймер перезаписываемым (MutableRefObject), а DOM-реф нерасходуемым.",
    isRaw: true,
    rawCandidate: ReactTsCandidate12,
    rawSolution: ReactTsSolution12,
    filepath: "src/react/tasks/5_react_ts/12_MutableVsImmutableRef.tsx",
    articles: [
      {
...
export const REACT_TS_PRACTICE_TASKS = [
  {
    ...
    filepath: "src/react/tasks/6_react_ts_practice/1_UseEffectFetch.tsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/6_react_ts_practice/2_RefetchImage.tsx",
    articles: [
      {
  ...
  },
  {
    ...
    filepath: "src/react/tasks/6_react_ts_practice/3_PostsManager.tsx",
    articles: [
      {
