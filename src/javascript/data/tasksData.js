...
export const JS_LOOPS_TASKS = [
  {
    ...
    desc: "Напишите базовый синтаксис цикла for (бесконечный цикл с пустыми выражениями) в JavaScript.",
    isRaw: true,
...
export const JS_FOR_OF_TASKS = [
  {
    ...
    desc: "Напишите базовый синтаксис цикла for...of для итерации по итерируемым объектам (массивам, строкам).",
    isRaw: true,
...
export const JS_ARRAYS_REDUCE_TASKS = [
  {
    ...
    desc: "Напишите базовый синтаксис свёртки массива методом Array.prototype.reduce().",
    isRaw: true,
