...
export const HomePracticeSections = memo(({ stats }: HomePracticeSectionsProps) => {
  return (
    <div className={styles.sectionBlock}>
      <div className={styles.blockHeader}>
        <FolderGit2 size={16} className={styles.blockIcon} />
      ...
      <div className={styles.galleryGrid}>
        <HomeSectionCard
          ...
          coverIcon={<Zap size={24} style={{ color: "#f59e0b" }} />}
          title="JavaScript"
          tagText={`${stats.jsTotal} задач`}
          tagClass={styles.tagAmber}
          description="Циклы (while, for, for...of), замыкания, рекурсия, прототипы, this, каррирование, полифилы Promise, Debounce/Throttle, Event Loop и утилиты объектов."
          tags={["#loops", "#closures", "#event-loop", "#promises"]}
        ...
        <HomeSectionCard
          ...
          coverIcon={<Code2 size={24} style={{ color: "var(--accent-blue)" }} />}
          title="React"
          tagText={`${stats.reactTotal} задач`}
          tagClass={styles.tagBlue}
          description="Практика кастомных хуков, паттерны рефакторинга компонентов, оптимизация перерендеров, Redux Toolkit, React Live Runner и TypeScript."
          tags={["#hooks", "#refactoring", "#rtk", "#typescript"]}
        ...
        <HomeSectionCard
          ...
          coverIcon={<Brain size={24} style={{ color: "#a855f7" }} />}
          title="Алгоритмы"
