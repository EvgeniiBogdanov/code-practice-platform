...
export const LineNumbers = forwardRef<HTMLDivElement, LineNumbersProps>(function LineNumbers(
  { lineCount, activeLine = 1, errorLines, warningLines, fontSize = 13, className },
  ref
) {
