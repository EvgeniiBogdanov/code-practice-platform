...
> = {
  ...
  math: [
    ...
    { label: "pow", insertText: "pow($1)", detail: "Math.pow(base, exp)", kind: "method" },
  ...
  array: [
    ...
    { label: "flat", insertText: "flat($1)", detail: "(depth) => Array", kind: "method" },
    {
      label: "flatMap",
      insertText: "flatMap($1)",
      detail: "(callback) => Array",
      kind: "method",
    },
    {
