...
export const useTimerStore = create<TimerState>((set, get) => ({
  ...
  setTimerSeconds: (secondsOrFn) => {
    const nextSeconds =
      typeof secondsOrFn === "function" ? secondsOrFn(get().timerSeconds) : secondsOrFn;
  ...
  setTimerRunning: (runningOrFn) => {
    const isRunning =
      typeof runningOrFn === "function" ? runningOrFn(get().timerRunning) : runningOrFn;
  ...
  formatTimer: (totalSec: number | null) => {
