export const JS_HINTS = {
  ...
  "js14": {
      "level1": {
          ...
          "content": "Метод `Array.prototype.includes(el)` выполняет линейный поиск элемента в массиве за O(N) по времени и O(1) памяти."
      },
      "level2": {
          "title": "Set vs includes",
          "content": "Оборачивание `new Set(arr).has(el)` внутри разовой функции требует O(N) времени и O(N) памяти на построение коллекции, поэтому не дает преимуществ для единичного поиска."
      },
      "level3": {
          "title": "Решение",
          "content": "const hasElem = (arr, el) => arr.includes(el);"
      }
  },
  "js15": {
      "level1": {
  ...
  "js63": {
      "level1": {
          ...
          "content": "Вычислите сумму всех элементов массива с помощью `reduce()`, а затем разделите ее на `numbers.length`."
      },
      "level2": {
          "title": "Граничные случаи",
          "content": "Проверьте `numbers.length === 0`, чтобы не получить деление на 0 (`NaN`)."
      },
      "level3": {
          "title": "Решение",
          "content": "const average = (numbers) => numbers.length === 0 ? 0 : numbers.reduce((acc, n) => acc + n, 0) / numbers.length;"
      }
  },
  "js64": {
      "level1": {
          "title": "Идея и ментальная модель",
          "content": "Для свертки массива пар `[ключ, значение]` в единый объект используйте `reduce()` с начальным значением `{}` или нативный метод `Object.fromEntries()`."
      },
      "level2": {
          "title": "Граничные случаи и оптимизация",
          "content": "Деструктурируйте пару `[course, hours]` прямо в параметрах редюсера. Присваивайте `acc[course] = hours` напрямую без спреда `{ ...acc }`, чтобы избежать квадратичной сложности O(N²)."
      },
      "level3": {
          "title": "Решение",
  ...
  "js65": {
      "level1": {
          "title": "Идея и ментальная модель",
          "content": "Для одновременной группировки и суммирования используйте `reduce()` с начальным значением `{}`. На каждом шаге извлекайте `{ category, amount }`."
      },
      "level2": {
          "title": "Граничные случаи и оптимизация",
          "content": "Инициализируйте счетчик категории нулем с помощью оператора `acc[category] ??= 0`, после чего прибавляйте расход: `acc[category] += amount`."
      },
      "level3": {
          "title": "Решение",
  ...
  "js66": {
      "level1": {
          "title": "Идея и ментальная модель",
          "content": "Используйте метод `reduce()` с начальным аккумулятором `{}`. Ключами объекта будут категории (`product.category`), а значениями — массивы названий (`product.name`)."
      },
      "level2": {
          "title": "Граничные случаи и оптимизация",
          "content": "Для инициализации массива группы используйте оператор логического присваивания `acc[product.category] ??= []`. Затем добавляйте название товара через `push(product.name)`."
      },
      "level3": {
          "title": "Решение",
  ...
  "js67": {
      "level1": {
          "title": "Идея и ментальная модель",
          "content": "Для построения двухуровневого объекта используйте `reduce()` с начальным аккумулятором `{}`. На 1-м уровне ключами будут страны (`acc[country]`), на 2-м — идентификаторы (`acc[country][id]`)."
      },
      "level2": {
          "title": "Граничные случаи и оптимизация",
          "content": "Инициализируйте объект страны через оператор логического присваивания `acc[country] ??= {}`. Затем запишите данные пользователя: `acc[country][id] = { age, name, country }`."
      },
      "level3": {
          "title": "Решение",
  ...
  "js120": {
      "level1": {
          ...
          "content": "Проверьте `signal?.aborted` перед запросом и передайте `{ signal }` в опции вызова `customFetch(url, { signal })`."
      },
      "level2": {
          "title": "Обработка ошибки",
          "content": "Если `signal.aborted` уже истинно, выбросьте `signal.reason || new DOMException('Aborted', 'AbortError')`."
      },
      "level3": {
          "title": "Решение",
          "content": "const fetchWithCancel = async (url, signal, customFetch = fetch) => { if (signal?.aborted) throw new DOMException('Aborted', 'AbortError'); const res = await customFetch(url, { signal }); return res.json(); };"
      }
  },
  "js121": {
      "level1": {
  ...
  "js122": {
      "level1": {
          "title": "Async Debounce с отменой in-flight",
          "content": "При новом вызове сбрасывайте `clearTimeout(timer)` И отменяйте активный `AbortController` предыдущего незавершенного запроса."
      },
      "level2": {
          "title": "Race conditions",
          "content": "Отклоняйте промис предыдущего вызова с `AbortError`, чтобы устаревший ответ не перезаписал актуальное состояние."
      },
      "level3": {
          "title": "Решение",
          "content": "Храните activeController и activeReject в замыкании; при новом вызове вызывайте activeController.abort() и activeReject(new DOMException('Aborted', 'AbortError'))."
      }
  },
  "js126": {
      "level1": {
  ...
  "js144": {
      "level1": {
          "title": "Сбор чисел из объекта",
          "content": "Рекурсивно обходите свойства объекта: если `typeof value === 'number'`, добавляйте в результат; если объект — спускайтесь рекурсивно."
      },
      "level2": {
          "title": "Отсечение null",
          "content": "Учитывайте, что `typeof null === 'object'`, проверяйте `typeof value === 'object' && value !== null`."
      },
      "level3": {
          "title": "Решение",
          "content": "const getAllPrimitives = (obj) => { const res = []; for (const k in obj) { if (typeof obj[k] === 'number') res.push(obj[k]); else if (typeof obj[k] === 'object' && obj[k] !== null) res.push(...getAllPrimitives(obj[k])); } return res; };"
      }
  },
  "js145": {
      "level1": {
  ...
  "js152": {
      "level1": {
          "title": "Мутабельные свойства в прототипе",
          "content": "Свойства, объявленные на `User.prototype`, разделяются всеми экземплярами. Мутация массива через `u1.skills.push()` изменяет массив для всех объектов."
      },
      "level2": {
          "title": "Цепочка прототипов",
          "content": "Экземпляр `u2` считывает свойство `skills` из прототипа, видя внесенные изменения `['JS']`."
      },
      "level3": {
          "title": "Вывод",
          "content": "console.log(u2.skills); // ['JS']"
      }
  },
  "js153": {
      "level1": {
          "title": "Стрелочные функции и this",
          "content": "Стрелочные функции не имеют собственного `this` и захватывают его из окружающего лексического контекста метода `start()`."
      },
      "level2": {
          "title": "Таймер setTimeout",
          "content": "Внутри колбэка `this` указывает на объект `timer`, поэтому `this.seconds++` корректно увеличивает свойство объекта."
      },
      "level3": {
          "title": "Вывод",
          "content": "console.log(this.seconds); // 1"
      }
  },
  "js154": {
      "level1": {
  ...
  "js157": {
      "level1": {
          "title": "Каррирование с приведением к числу",
          "content": "Возвращаемая функция `f(b)` накапливает сумму в замыкании и возвращает саму себя для продолжения цепочки."
      },
      "level2": {
          "title": "Symbol.toPrimitive и valueOf",
          "content": "Определите `f[Symbol.toPrimitive] = () => currentSum` и `f.valueOf = () => currentSum` для автоматического приведения к числу."
      },
      "level3": {
          "title": "Решение",
          "content": "function sum(a) { let cur = a; function f(b) { cur += b; return f; } f[Symbol.toPrimitive] = () => cur; f.valueOf = () => cur; return f; }"
      }
  },
  "js158": {
      "level1": {
  ...
  "js181": {
      "level1": {
          "title": "Event Loop: микрозадачи и рендеринг",
          "content": "Синхронный код (A, E) и микрозадачи промисов (D) всегда выполняются первыми."
      },
      "level2": {
          "title": "setTimeout vs requestAnimationFrame",
          "content": "Порядок вывода между setTimeout (макрозадача) и rAF (колбэк рендеринга) зависит от момента запуска фазы перерисовки браузера."
      },
      "level3": {
          "title": "Вывод",
          "content": "Синхронно: A, E -> Микрозадача: D -> Макрозадача/rAF: B, C (или C, B в зависимости от кадра)."
      }
  },
  "js182": {
      "level1": {
  ...
  "js196": {
      ...
      "level3": {
          "title": "Псевдокод и сигнатура",
          "content": "const createCategoryTree = (list) => { const nodeMap = new Map(); list.forEach(({ title }) => nodeMap.set(title, { title })); const roots = []; list.forEach(({ title, parent }) => { const node = nodeMap.get(title); if (parent === null) { node.children = node.children || []; roots.push(node); return; } const parentNode = nodeMap.get(parent); if (!parentNode) return; parentNode.children = parentNode.children || []; parentNode.children.push(node); }); return roots; };"
      }
  },
  "js90": {
      "level1": {
          "title": "Конструктор Map",
          "content": "Конструктор `new Map(iterable)` принимает массив пар `[key, value]` (например `[['a', 1], ['b', 2]]`)."
      },
      "level2": {
          "title": "Структура пар",
          "content": "Каждый элемент входного массива должен быть массивом из двух значений: ключа и значения."
      },
      "level3": {
          "title": "Решение",
          "content": "const createMapFromPairs = (pairs) => new Map(pairs);"
      }
  },
  "js186": {
      "level1": {
          "title": "Правила приведения типов",
          "content": "`typeof null === \"object\"` (историческая особенность). `typeof NaN === \"number\"`. `===` сравнивает без приведения типов."
      },
      "level2": {
          "title": "Сравнение ссылок и абстрактное равенство",
          "content": "`[] === []` возвращает `false`, так как это разные ссылки. `[] == ![]` дает `true`, так как `![] → false → 0` и `[] → \"\" → 0`."
      },
      "level3": {
          "title": "Арифметика",
          "content": "`+` с участием строки выполняет конкатенацию (\"5\" + 3 → \"53\"), а `-` всегда приводит к числу (\"5\" - 3 → 2)."
      }
  },
  "js187": {
      "level1": {
          "title": "Сравнение объектов и неявные вызовы",
          "content": "Объекты сравниваются по ссылке. При операциях с объектами вызываются `Symbol.toPrimitive`, `valueOf` или `toString`."
      },
      "level2": {
          "title": "Контекст выражения {} + []",
          "content": "В выражении `{}` может интерпретироваться как пустой блок кода, если стоит в начале строки, тогда `+[]` даст `0`. В выражении `({} + [])` объект преобразуется в `\"[object Object]\"`."
      },
      "level3": {
          "title": "Объекты в ключах",
          "content": "Обычный объект преобразует любые объектные ключи в строку `\"[object Object]\"`. Для сохранения объектов-ключей используйте `Map`."
      }
  },
  "js188": {
      "level1": {
          "title": "Проверка типов и Object.is",
          "content": "`Object.is(NaN, NaN)` возвращает `true`, а `Object.is(+0, -0)` возвращает `false`. Для проверки массивов используйте `Array.isArray()`."
      },
      "level2": {
          "title": "Разница между || и ??",
          "content": "`||` срабатывает на любые falsy значения (0, '', false, null, undefined, NaN), а `??` — только на `null` и `undefined`."
      },
      "level3": {
          "title": "Надежная проверка на null",
          "content": "Используйте `value === null`, так как `typeof null` возвращает 'object'."
      }
  },
  "js189": {
      "level1": {
          "title": "Синтаксис for...in",
          "content": "Цикл `for (const key in obj)` перебирает строковые имена всех перечислимых свойств объекта."
      },
      "level2": {
          "title": "Цепочка прототипов",
          "content": "`for...in` обходит не только собственные свойства, но и свойства прототипа. Для отсечения унаследованных используйте `Object.hasOwn(obj, key)`."
      },
      "level3": {
          "title": "Решение",
          "content": "for (const key in obj) { console.log(key, obj[key]); }"
      }
  },
  "js190": {
      "level1": {
          "title": "Суммирование значений",
          "content": "Инициализируйте аккумулятор `let sum = 0` и пройдитесь по свойствам объекта с помощью `for...in`."
      },
      "level2": {
          "title": "Фильтрация собственных свойств",
          "content": "Проверяйте `Object.hasOwn(salaries, key)` и прибавляйте `sum += salaries[key]`."
      },
      "level3": {
          "title": "Решение",
          "content": "const sumSalaries = (salaries) => { let sum = 0; for (const k in salaries) if (Object.hasOwn(salaries, k)) sum += salaries[k]; return sum; };"
      }
  },
  "js191": {
      "level1": {
          "title": "Подсчет свойств",
          "content": "Счетчик `let count = 0` увеличивается на 1 при обнаружении каждого собственного свойства."
      },
      "level2": {
          "title": "Прототипные свойства",
          "content": "Не забывайте игнорировать унаследованные свойства через `Object.hasOwn(obj, key)`."
      },
      "level3": {
          "title": "Решение",
          "content": "const countProps = (obj) => { let c = 0; for (const k in obj) if (Object.hasOwn(obj, k)) c++; return c; };"
      }
  },
  "js192": {
      "level1": {
          "title": "Мутация числовых свойств",
          "content": "Проверяйте тип каждого свойства через `typeof obj[key] === 'number'`."
      },
      "level2": {
          "title": "Умножение",
          "content": "Если свойство числовое, умножьте его: `obj[key] *= 2`."
      },
      "level3": {
          "title": "Решение",
          "content": "const multiplyNumeric = (obj) => { for (const k in obj) if (Object.hasOwn(obj, k) && typeof obj[k] === 'number') obj[k] *= 2; };"
      }
  },
  "js193": {
      "level1": {
          "title": "Сбор значений в массив",
          "content": "Создайте массив `const values = []` и пушьте в него `obj[key]`."
      },
      "level2": {
          "title": "Только собственные свойства",
          "content": "Используйте `if (Object.hasOwn(obj, key)) values.push(obj[key])`."
      },
      "level3": {
          "title": "Решение",
  ...
  "js194": {
      "level1": {
          "title": "Ранний выход",
          "content": "Если цикл `for...in` находит хотя бы одно собственное свойство, сразу возвращайте `false`."
      },
      "level2": {
          "title": "Проверка Object.hasOwn",
          "content": "Без `Object.hasOwn(obj, key)` объект с унаследованными свойствами будет ошибочно признан непустым."
      },
      "level3": {
          "title": "Решение",
          "content": "const isEmpty = (obj) => { for (const k in obj) if (Object.hasOwn(obj, k)) return false; return true; };"
      }
  },
  "js195": {
      "level1": {
          "title": "Инвертирование объекта",
          "content": "Создайте новый объект `const result = {}` и запишите `result[obj[key]] = key`."
      },
      "level2": {
          "title": "Коллизии значений",
          "content": "Если значения дублируются, более позднее перезапишет предыдущее."
      },
      "level3": {
          "title": "Решение",
          "content": "const invertObject = (obj) => { const res = {}; for (const k in obj) if (Object.hasOwn(obj, k)) res[obj[k]] = k; return res; };"
      }
  },
};
