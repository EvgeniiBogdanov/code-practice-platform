...
export const ALGO_GROUP_CONFIG = {
  ...
  "Two Pointers": {
    ...
    practiceTasksList: [
      { id: "algo38", title: "Remove Element (LeetCode #27)", desc: "базовый read/write без обменов и дополнительных структур", isInternal: true },
      ...
      { id: "algo37", title: "Sort Array By Parity (LeetCode #905)", desc: "перестановка чётных и нечётных чисел на месте (in-place partitioning)", isInternal: true },
  ...
  "Prefix Sum": {
    ...
    practiceTasksList: [
      { id: "algo39", title: "Running Sum of 1d Array (LeetCode #1480)", desc: "построение накопительной суммы одним проходом", isInternal: true },
  ...
  "Stack": {
    ...
    practiceTasksList: [
      { id: "algo40", title: "Remove All Adjacent Duplicates in String (LeetCode #1047)", desc: "базовые операции push/pop по вершине стека", isInternal: true },
  ...
  "Depth-First Search": {
    ...
    practiceTasksList: [
      { id: "algo41", title: "Binary Tree Preorder Traversal (LeetCode #144)", desc: "чистый рекурсивный обход root-left-right", isInternal: true },
  ...
  "Breadth-First Search": {
    ...
    practiceTasksList: [
      { id: "algo42", title: "Minimum Depth of Binary Tree (LeetCode #111)", desc: "поуровневый BFS с ранним выходом на первом листе", isInternal: true },
      ...
      { id: "algo43", title: "Flood Fill (LeetCode #733)", desc: "базовый BFS по четырём соседям матрицы", isInternal: true },
  ...
  "Backtracking": {
    ...
    practiceTasksList: [
      { id: "algo44", title: "Generate Binary Strings", desc: "минимальное дерево решений с выбором 0 или 1", isInternal: true },
