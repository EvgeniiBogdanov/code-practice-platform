...
1. **Оценка истинности положительных чисел**:
\`\`\`js
const arr = [1, 2, 3];
...
1. **Фиксированное добавление свойства**:
\`\`\`js
const products = [
...
2. **Универсальное динамическое добавление по ключу**:
\`\`\`js
...
1. **Запись фундаментального шаблона**:
\`\`\`js
