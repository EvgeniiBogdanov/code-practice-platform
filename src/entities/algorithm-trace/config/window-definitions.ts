...
export const windowDefinitions = {
  ...
  algo9: {
    ...
    examples: [
      ...
      { id: "negative", label: "Отрицательные средние: [-5, -2, -8, -1], k = 2", input: "-5, -2, -8, -1", parameter: "2" },
      { id: "whole", label: "Окно во весь массив: [1, 2, 3], k = 3", input: "1, 2, 3", parameter: "3" },
    ],
  },
  algo10: {
    ...
    examples: [
      ...
      { id: "none", label: "Недостаточная сумма: [1, 1, 1], target = 8", input: "1, 1, 1", parameter: "8" },
