...
> 🌐 **Быстрый доступ:**
> - **[🚀 Открыть онлайн-версию](https://code-practice-platform-omega.vercel.app/home)** — *Практика прямо в браузере без установки.*
> - **[📥 Локальный запуск](#-установка-и-запуск)** — *Для локальной разработки и практики.*
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🎯 280+ задач с реальных интервью</h3>
...
| **Стилизация & UI** | **CSS Modules** (`*.module.css`), **clsx 2**, Дизайн-токены CSS Variables, `click-to-react-component` |
