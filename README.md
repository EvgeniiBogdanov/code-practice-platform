...
<sub><span style="color:gray">version: 2.3.7</span></sub>
...
- **[v2.3.7](CHANGELOG.md#v2-3-7)** — Связанный сброс прогресса и кода решений с повторениями SM-2, синхронизация редактора при сбросе, опция отключения интерактивного помощника, унификация компонента Input и нулевая специфичность CSS Reset.
